...
private:
    ...
    std::map<int,std::vector<int>> priority_to_ports_map; //the priority is the key, the vector of ports with that priority is the value. more ports with the same priority are handled as round robin
};
